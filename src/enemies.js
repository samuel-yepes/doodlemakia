...
export class EnemyManager {
  ...
  _breakShield(e) {
    ...
    e.hit = e.hit.filter((h) => h[0] !== 'shield'); e.hitSpheres = e.hit.map(() => new THREE.Vector3()); e.J.shieldG = null; audio.shieldHit(e.center); this.ctx.game.addScore(40, 'Escudo destruido');
  }
  kill(e, info) {
